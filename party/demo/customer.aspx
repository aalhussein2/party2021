<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="customer.aspx.cs" Inherits="party.demo.customer" %>
                        ...
                        <tr>
                            <td colspan="2" align="center">
                                <asp:Button ID="btnSave2" runat="server" 
                                    OnClick="btnSave2_Click" Text="Save2" />
